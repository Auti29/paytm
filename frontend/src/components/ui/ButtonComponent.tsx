    ...
    return (
        <div>
            ...
            className={props.disabled ? (
                props.style ?
                `bg-gray-400 text-white pl-3 pr-3 pt-1.5 pb-1.5 rounded-md font-sans text-sm font-bold cursor-pointer ${props.style}`
            :
            `bg-gray-400 text-white pl-3 pr-3 pt-1.5 pb-1.5 rounded-md font-sans text-sm font-bold cursor-pointer`
            )
                :
                (props.style ?
